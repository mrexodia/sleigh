...
set(ghidra_patches
  PATCH_COMMAND "${GIT_EXECUTABLE}" config user.name "CMake" &&
  "${GIT_EXECUTABLE}" config user.email "patch@cmake" &&
...
if("${sleigh_RELEASE_TYPE}" STREQUAL "HEAD")
  ...
  set(ghidra_head_git_tag "2536099c0eb2683ee0e416a127f8a8795f8de853")
  set(ghidra_git_tag "${ghidra_head_git_tag}")
  set(ghidra_shallow FALSE)
  set(ghidra_patches
    PATCH_COMMAND PATCH_COMMAND "${GIT_EXECUTABLE}" config user.name "CMake" &&
    "${GIT_EXECUTABLE}" config user.email "patch@cmake" &&
    "${GIT_EXECUTABLE}" am --ignore-space-change --ignore-whitespace --no-gpg-sign
